...
indices_train = np.load("indices/indices_train_shadow.npy")
indices_test = np.load("indices/indices_test_shadow.npy")
...
for step in np.arange(50000):
    ...
    if (step % 1000 == 0):
        model.save_weights("weights/svhn_" + str(step) + "_acc_train:" + str(acc_train) + "_acc_test: " + str(acc_test) + "_shadow.hdf5")


#model.load_weights("weights/svhn_0046_0.995360_0.926400_shadow.hdf5")
#
#print(model.evaluate(X_train, Y_train, verbose=0))
#print(model.evaluate(X_test, Y_test, verbose=0))
#
#model.save("models/SVHN_shadow.h5")
