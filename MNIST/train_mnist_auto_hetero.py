...
l = Reshape((28,28,1))(inputs)
l = Conv2D(filters=10, kernel_size=(3,3), use_bias=False)(l)
l = Flatten()(l)
...
#inputs= Input(shape=(784,))
#l = Dense(800, activation="relu", use_bias=True, kernel_initializer="glorot_normal")(inputs)
#l = Dense(800, activation="relu", use_bias=True, kernel_initializer="glorot_normal")(l)
#l  = Dense(800, activation="relu", use_bias=True, kernel_initializer="glorot_normal")(l)
#
...
#l  = Dense(800, activation="relu", use_bias=True, kernel_initializer="glorot_normal")(aux)
...
for step in np.arange(25000):
    ...
    if (step % 500 == 0):
        model_auto_hetero.save_weights("weights/mnist_autohetero_step:" + str(step) + "_acc_test:" + str(acc_test) + "_bcetest:" + str(bce_test) + ".hdf5")


#model_auto_hetero.load_weights("weights/2mnist_autohetero_shadow_step:24500_acc_test:0.9662_bcetest:0.07981054.hdf5")
#model_auto_hetero.save("models/2MNIST_auto_hetero.h5")


#model_auto_hetero.load_weights("weights/mnist_autohetero_step:24500_acc_test:0.9684_bcetest:0.07942879.hdf5")
...
#
#
#x = np.reshape(X_test[i:(i+1)], (1 , 784))
#im = model_auto_hetero.predict(x)[0]
#
#plt.figure()
