...
for step in np.arange(50000):
    ...
    if (step % 1000 == 0):
        model.save_weights("weights/mnist_" + str(step) + "_acc_train:" + str(acc_train) + "_acc_test: " + str(acc_test) + "_shadow.hdf5")


        
#model.load_weights("weights/fmnist_0004_0.840514_0.837000.hdf5")
#
#print(model.evaluate(X_train, Y_train, verbose=0))
#print(model.evaluate(X_test, Y_test, verbose=0))
#
#model.save("models/FMNIST_shadow2.h5")
